...
Given a user query, inspect the Query Agent output and MLflow traces. Explain which capabilities were parsed, which filters removed candidates, and whether ranking was driven more by trust, contradiction penalties, or distance.
